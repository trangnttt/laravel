...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        rowClick: function(args) {
            if(this.editing) {
                this.editItem(jQuery(args.event.target).closest("tr"));
            }
        },
        rowDoubleClick: $.noop,
        ...
        _attachWindowLoadResize: function() {
            jQuery(window).on("load", $.proxy(this._refreshSize, this));
        },

        _attachWindowResizeCallback: function() {
            if(this.updateOnResize) {
                jQuery(window).on("resize", $.proxy(this._refreshSize, this));
            }
        },

        _detachWindowResizeCallback: function() {
            jQuery(window).off("resize", this._refreshSize);
        },
        ...
        _createHeader: function() {
            ...
            var $headerGrid = this._headerGrid = jQuery("<table>").addClass(this.tableClass)
                .append($headerRow)
                .append($filterRow)
                .append($insertRow);

            var $header = this._header = jQuery("<div>").addClass(this.gridHeaderClass)
        ...
        _createBody: function() {
            var $content = this._content = jQuery("<tbody>");

            var $bodyGrid = this._bodyGrid = jQuery("<table>").addClass(this.tableClass)
                .append($content);

            var $body = this._body = jQuery("<div>").addClass(this.gridBodyClass)
                .append($bodyGrid)
        ...
        _createPagerContainer: function() {
            var pagerContainer = this.pagerContainer || jQuery("<div>").appendTo(this._container);
            return jQuery(pagerContainer).addClass(this.pagerContainerClass);
        },
        ...
        _createHeaderRow: function() {
            if($.isFunction(this.headerRowRenderer))
                return jQuery(this.renderTemplate(this.headerRowRenderer, this));

            var $result = jQuery("<tr>").addClass(this.headerRowClass);
        ...
        _prepareCell: function(cell, field, cssprop, cellClass) {
            return jQuery(cell).css("width", field.width)
        ...
        _createFilterRow: function() {
            if($.isFunction(this.filterRowRenderer))
                return jQuery(this.renderTemplate(this.filterRowRenderer, this));

            var $result = jQuery("<tr>").addClass(this.filterRowClass);
        ...
        _createInsertRow: function() {
            if($.isFunction(this.insertRowRenderer))
                return jQuery(this.renderTemplate(this.insertRowRenderer, this));

            var $result = jQuery("<tr>").addClass(this.insertRowClass);
        ...
        _createNoDataRow: function() {
            ...
            return jQuery("<tr>").addClass(this.noDataRowClass)
                .append(jQuery("<td>").addClass(this.cellClass).attr("colspan", amountOfFields)
        ...
        _attachRowHover: function($row) {
            ...
            $row.hover(function() {
                    jQuery(this).addClass(selectedRowClass);
                },
                function() {
                    jQuery(this).removeClass(selectedRowClass);
                }
            );
        },
        ...
        _createCell: function(item, field) {
            ...
            if($.isFunction(field.cellRenderer)) {
                ...
                $result = jQuery("<td>").append(this.renderTemplate(field.itemTemplate || fieldValue, field, args));
            }
        ...
        _createPager: function() {
            ...
            if($.isFunction(this.pagerRenderer)) {
                $result = jQuery(this.pagerRenderer({
                    pageIndex: this.pageIndex,
                    pageCount: this._pagesCount()
                }));
            } else {
                $result = jQuery("<div>").append(this._createPagerByFormat());
            }
        ...
        _createPagerButton: function(text, css, handler) {
            var $link = jQuery("<a>").attr("href", EMPTY_HREF)
                .html(text)
                .on("click", $.proxy(handler, this));

            return jQuery("<span>").addClass(css).append($link);
        },
        ...
        _scrollBarWidth: (function() {
            ...
            return function() {
                if(result === undefined) {
                    var $ghostContainer = jQuery("<div style='width:50px;height:50px;overflow:hidden;position:absolute;top:-10000px;left:-10000px;'></div>");
                    var $ghostContent = jQuery("<div style='height:100px;'></div>");
        ...
        _createEditRow: function(item) {
            if($.isFunction(this.editRowRenderer)) {
                return jQuery(this.renderTemplate(this.editRowRenderer, this, { item: item, itemIndex: this._itemIndex(item) }));
            }

            var $result = jQuery("<tr>").addClass(this.editRowClass);
        ...
        _rowIndex: function(row) {
            return this._content.children().index(jQuery(row));
        },
...
(function(jsGrid, $, undefined) {
    ...
    LoadIndicator.prototype = {
        ...
        _initContainer: function() {
            this._container = jQuery(this.container);
        },
        ...
        _initShader: function() {
            ...
            this._shader = jQuery("<div>").addClass(this.shaderClass)
                .hide()
                .css({
                    position: "absolute",
                    top: 0,
        ...
        _initLoadPanel: function() {
            this._loadPanel = jQuery("<div>").addClass(this.loadPanelClass)
                .text(this.message)
                .hide()
                .css({
                    position: "absolute",
...
(function(jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        _createTextBox: function() {
			return jQuery("<input>").attr("type", "number")
                .prop("readonly", !!this.readOnly);
        }
    });
...
(function(jsGrid, $, undefined) {
    ...
    TextAreaField.prototype = new TextField({
        ...
        _createTextArea: function() {
            return jQuery("<textarea>").prop("readonly", !!this.readOnly);
        }
    });
...
(function(jsGrid, $, undefined) {
    ...
    CheckboxField.prototype = new Field({
        ...
        _createCheckbox: function() {
            return jQuery("<input>").attr("type", "checkbox");
        }
    });
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        _createGridButton: function(cls, tooltip, clickHandler) {
            ...
            return jQuery("<input>").addClass(this.buttonClass)
                .addClass(cls)
                .attr({
                    type: "button",
                    title: tooltip
