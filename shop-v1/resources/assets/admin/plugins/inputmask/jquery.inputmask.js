    ...
    return modules = [ function(module) {
        ...
        Inputmask.prototype = {
            ...
            setValue: function setValue(value) {
                this.el && jQuery(this.el).trigger("setvalue", [ value ]);
            },
            ...
            "string" == typeof elems && (elems = document.getElementById(elems) || document.querySelectorAll(elems)), 
            elems = elems.nodeName ? [ elems ] : elems, $.each(elems, function(ndx, el) {
                el.inputmask ? el.inputmask.setValue(value) : jQuery(el).trigger("setvalue", [ value ]);
            });
        };
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
            ...
            var EventRuler = {
                on: function on(input, eventName, eventHandler) {
                    ...
                    -1 !== $.inArray(eventName, [ "submit", "reset" ]) ? null !== input.form && jQuery(input.form).on(eventName, ev) : jQuery(input).on(eventName, ev);
                },
                off: function off(input, event) {
                    ...
                    $.each(events, function(eventName, evArr) {
                        for (;0 < evArr.length; ) {
                            var ev = evArr.pop();
                            -1 !== $.inArray(eventName, [ "submit", "reset" ]) ? null !== input.form && jQuery(input.form).off(eventName, ev) : jQuery(input).off(eventName, ev);
                        }
                ...
                keydownEvent: function keydownEvent(e) {
                    var input = this, $input = jQuery(input), k = e.keyCode, pos = caret(input), kdResult = opts.onKeyDown.call(this, e, getBuffer(), pos, opts);
            ...
            function mask(elem) {
                ...
                if (!1 !== isSupported) {
                    el = elem, $el = jQuery(el), originalPlaceholder = el.placeholder, maxLength = void 0 !== el ? el.maxLength : void 0, 
            ...
            if (void 0 !== actionObj) switch (actionObj.action) {
              ...
              case "remove":
                if (el && el.inputmask) {
                    $.data(el, "_inputmask_opts", null), $el = jQuery(el);
