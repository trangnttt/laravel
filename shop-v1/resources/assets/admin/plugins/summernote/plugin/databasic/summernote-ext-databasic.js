  ...
  var DataBasicPlugin = function(context) {
    ...
    self.events = {
      'summernote.init': function(we, e) {
        ...
        jQuery('data.ext-databasic', e.editable).each(function() { self.setContent(jQuery(this)); });
    ...
    self.initialize = function() {
      ...
      var $container = options.dialogsInBody ? jQuery(document.body) : context.layoutInfo.editor;
    ...
    self.update = function() {
      ...
      if (rng.isOnData()) {
        var $data = jQuery(rng.sc).closest('data.ext-databasic');
    ...
    self.createNode = function(info) {
      var $node = jQuery('<data class="ext-databasic"></data>');
