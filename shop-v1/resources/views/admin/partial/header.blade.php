      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('admin.slide.add') }}" class="nav-link {{ $currentRouter === 'admin.slide.add'  ? ' active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Add</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('admin.slide') }}" class="nav-link {{ $currentRouter === 'admin.slide'  ? ' active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>List</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          <a href="{{ route('admin.product-type') }}" class="nav-link {{ $currentRouter === 'admin.product_type'  ? ' active' : '' }}">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('admin.product.add') }}" class="nav-link {{ $currentRouter === 'admin.product.add'  ? ' active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Add</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('admin.product.list') }}" class="nav-link {{ $currentRouter === 'admin.product.list'  ? ' active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>List</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          <a href="{{ route('admin.bill.list') }}" class="nav-link">
