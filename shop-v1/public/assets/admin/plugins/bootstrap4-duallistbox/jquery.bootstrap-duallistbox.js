...
(function(factory) {
  ...
  function sortOptions(select) {
    select.find('option').sort(function(a, b) {
      return (jQuery(a).data('original-index') > jQuery(b).data('original-index')) ? 1 : -1;
    }).appendTo(select);
  }
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.elements = {
        ...
        box1: jQuery('.box1', this.container),
        box2: jQuery('.box2', this.container),
        filterInput1: jQuery('.box1 .filter', this.container),
        filterInput2: jQuery('.box2 .filter', this.container),
        filterClear1: jQuery('.box1 .clear1', this.container),
        filterClear2: jQuery('.box2 .clear2', this.container),
        label1: jQuery('.box1 > label', this.container),
        label2: jQuery('.box2 > label', this.container),
        info1: jQuery('.box1 .info', this.container),
        info2: jQuery('.box2 .info', this.container),
        select1: jQuery('.box1 select', this.container),
        select2: jQuery('.box2 select', this.container),
        moveButton: jQuery('.box1 .move', this.container),
        removeButton: jQuery('.box2 .remove', this.container),
        moveAllButton: jQuery('.box1 .moveall', this.container),
        removeAllButton: jQuery('.box2 .removeall', this.container),
        form: jQuery(jQuery('.box1 .filter', this.container)[0].form)
      };
    ...
    if (options === undefined || typeof options === 'object') {
      return this.each(function () {
        ...
        if (!jQuery(this).is('select')) {
          jQuery(this).find('select').each(function(index, item) {
            // For each nested select, instantiate the Dual List Box
            jQuery(item).bootstrapDualListbox(options);
          });
