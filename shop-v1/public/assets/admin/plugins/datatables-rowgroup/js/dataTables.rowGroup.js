...
$.extend( RowGroup.prototype, {
	...
	dataSrc: function ( val )
	{
		...
		jQuery(dt.table().node()).triggerHandler( 'rowgroup-datasrc.dt', [ dt, val ] );
	...
	{
		jQuery( 'tr.'+this.c.className, this.s.dt.table().body() ).find('td')
...
jQuery(document).on( 'preInit.dt.dtrg', function (e, settings, json) {
	if ( e.namespace !== 'dt' ) {
		return;
	}
