...
(function (factory) {
    ...
    var Mapael = function (container, options) {
        ...
        self.$map = jQuery("." + self.options.map.cssClass, self.container);
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            if (self.options.map.cssClass === "" || jQuery("." + self.options.map.cssClass, self.container).length === 0) {
                throw new Error("The map class `" + self.options.map.cssClass + "` doesn't exists");
            }

            // Create the tooltip container
            self.$tooltip = jQuery("<div>").addClass(self.options.map.tooltip.cssClass).css("display", "none");
            ...
            jQuery(self.paper.desc).append(" and Mapael " + self.version + " (https://www.vincentbroute.fr/mapael/)");
        },
         ...
         *     jQuery(".mapcontainer").data("mapael").destroy();
         *
        ...
        destroy: function () {
            ...
            if (self.onResizeEvent) jQuery(window).off("resize." + pluginName, self.onResizeEvent);
        ...
        initResponsiveSize: function () {
            ...
            jQuery(window).on("resize." + pluginName, self.onResizeEvent);
        ...
        initElem: function (id, type, elem) {
            var self = this;
            var $mapElem = jQuery(elem.mapElem.node);
            ...
            if (elem.options.text && elem.options.text.content !== undefined) {
                ...
                jQuery(elem.textElem.node).attr({
                    "data-id": id,
                    "data-type": type + '-text'
                });
            }
        ...
        initZoom: function (mapWidth, mapHeight, zoomOptions) {
            ...
            $.each(zoomOptions.buttons, function(type, opt) {
                ...
                var $button = jQuery("<div>").addClass(opt.cssClass)
                    .html(opt.content)
            ...
            jQuery("body").on("mouseup." + pluginName + (zoomOptions.touch ? " touchend." + pluginName : ""), function () {
                mousedown = false;
         ...
         * Triggered by user jQuery(".mapcontainer").trigger("showElementsInRange", [opt]);
         *
        ...
        onUpdateEvent: function (e, opt) {
            ...
            if (typeof opt.mapOptions === "object") {
                ...
                if (opt.mapOptions.areas !== undefined || opt.mapOptions.plots !== undefined || opt.mapOptions.legend !== undefined) {
                    jQuery("[data-type='legend-elem']", self.$container).each(function (id, elem) {
                        if (jQuery(elem).attr('data-hidden') === "1") {
                            // Toggle state of element by clicking
                            jQuery(elem).trigger("click", {hideOtherElems: false, animDuration: animDuration});
                        }
                    });
                }
            }
            ...
            if (typeof opt.setLegendElemsState === "object") {
                ...
                $.each(opt.setLegendElemsState, function (legendCSSClass, action) {
                    ...
                    if ($legend !== undefined) {
                        ...
                        jQuery("[data-type='legend-elem']", $legend).each(function (id, elem) {
                            if ((jQuery(elem).attr('data-hidden') === "0" && action === "hide") ||
                                (jQuery(elem).attr('data-hidden') === "1" && action === "show")) {
                                // Toggle state of element by clicking
                                jQuery(elem).trigger("click", {hideOtherElems: false, animDuration: animDuration});
                            }
                        });
        ...
        updateElem: function (elem, animDuration) {
            ...
            // Update the cssClass
            if (elem.options.cssClass !== undefined) {
                jQuery(elem.mapElem.node).removeClass().addClass(elem.options.cssClass);
            }
        },
        ...
        drawLegend: function (legendOptions, legendType, elems, scale, legendIndex) {
            ...
            $legend = jQuery("." + legendOptions.cssClass, self.$container);
            ...
            jQuery(legendPaper.canvas).attr({"data-legend-type": legendType, "data-legend-id": legendIndex});
        ...
        handleClickOnLegendElem: function(elem, id, legendIndex, legendType, opts) {
            ...
            var $legendElem = jQuery(legendElem.node);
            var $legendLabel = jQuery(legendLabel.node);
            ...
            if ((opts.hideOtherElems === undefined || opts.hideOtherElems === true) && legendOptions.exclusive === true ) {
                jQuery("[data-type='legend-elem'][data-hidden=0]", self.$container).each(function () {
                    var $elem = jQuery(this);
        ...
        createLegends: function (legendType, elems, scale) {
            ...
            for (var j = 0; j < legendsOptions.length; ++j) {
                if (legendsOptions[j].display === true  && $.isArray(legendsOptions[j].slices) && legendsOptions[j].slices.length > 0 &&
                    legendsOptions[j].cssClass !== "" && jQuery("." + legendsOptions[j].cssClass, self.$container).length !== 0
                ) {
    ...
    $.fn[pluginName] = function (options) {
        ...
        return this.each(function () {
            ...
            // This allow external access to Mapael using jQuery(".mapcontainer").data("mapael")
